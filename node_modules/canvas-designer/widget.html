...
<body>
    ...
    <section id="tool-box" class="tool-box">
        <canvas id="pencil-icon" width="40" height="40" title="Panchil" class="edittool"></canvas>
        <canvas id="marker-icon" width="40" height="40" title="Marker" class="edittool"></canvas>

        <canvas id="eraser-icon" width="40" height="40" title="Erase drawings" class="edittool"></canvas>
        <canvas id="text-icon" width="40" height="40" title="Write text" class="edittool"></canvas>
        <canvas id="image-icon" width="40" height="40" title="Add image" class="edittool"></canvas>

        <canvas id="pdf-icon" width="40" height="40" title="Add pdf" class="edittool"></canvas>

        <canvas id="drag-last-path" width="40" height="40" title="Drag/move last path" class="edittool"></canvas>
        <canvas id="drag-all-paths" width="40" height="40" title="Drag/move all paths" class="edittool"></canvas>

        <canvas id="line" width="40" height="40" title="Draw Lines" class="edittool"></canvas>
        <canvas id="arrow" width="40" height="40" title="Draw Arrows" class="edittool"></canvas>

        <canvas id="zoom-up" width="40" height="40" title="Zoon-In" class="edittool"></canvas>
        <canvas id="zoom-down" width="40" height="40" title="Zoom-Out" class="edittool"></canvas>

        <canvas id="arc" width="40" height="40" title="Arc" class="edittool"></canvas>
        <canvas id="rectangle" width="40" height="40" title="Rectangle" class="edittool"></canvas>
        <canvas id="quadratic-curve" width="40" height="40" title="Quadratic curve" class="edittool"></canvas>
        <canvas id="bezier-curve" width="40" height="40" title="Bezier curve" class="edittool"></canvas>

        <canvas id="undo" width="40" height="40" title="Undo: Remove recent shapes" class="edittool"></canvas>
<a class="fa fa-desktop text-dark fa-2x my-2 px-2" href="screen-sharing-teacher.html" title="screen share" style="text-decoration:none;"></a>
        <canvas id="line-width" width="40" height="40" title="Set line-width" class="edittool"></canvas>
        <canvas id="colors" width="40" height="40" title="Set foreground and background colors" class="edittool"></canvas>
        <canvas id="additional" width="40" height="40" title="Extra options" class="edittool"></canvas>
    </section>
